...
Co:  -This represents the carry output. 
     ...
     -The second AND gate consists of Ci (shown by the straight line) and at the junction point from the second AND gate consists of the 1st XOR gate deduced earlier which was X (A xor B)
...
S: -It consists of an XOR gate which also contains another XOR gate and Ci too indicated by the junction point where it either goes to that second XOR gate or straight to the second AND gate
