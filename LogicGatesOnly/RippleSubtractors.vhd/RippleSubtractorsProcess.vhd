...
entity ripple_subtractor_proc is 
...
end ripple_subtractor_proc;

architecture behavioural of ripple_subtractor_proc is
begin

  ripple_subtractor_process: process(A_0 , A_1 , A_2 , A_3 , B_0 , B_1 , B_2 , B_3 , C_in)
    variable C_0, C_1, C_2: std_logic;
  ...
  begin
    ...
    S_2 <= ((A_2 xor (not B_2)) xor C_1);                            --Individual equations for S_0 and C_0 respectively    (:= is used as some variable components are signals (both inputs and outputs))
 ...
 end process ripple_subtractor_process;
end behavioural;
